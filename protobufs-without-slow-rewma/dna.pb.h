...
class WhiskerTree : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_config(::RemyBuffers::ConfigRange* config);
  ...
  inline void set_allocated_optimizer(::RemyBuffers::OptimizationSettings* optimizer);
...
class OptimizationSettings : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_window_increment(::RemyBuffers::OptimizationSetting* window_increment);
  ...
  inline void set_allocated_window_multiple(::RemyBuffers::OptimizationSetting* window_multiple);
  ...
  inline void set_allocated_intersend(::RemyBuffers::OptimizationSetting* intersend);
...
class ConfigRange : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_link_packets_per_ms(::RemyBuffers::Range* link_packets_per_ms);
  ...
  inline void set_allocated_rtt(::RemyBuffers::Range* rtt);
  ...
  inline void set_allocated_num_senders(::RemyBuffers::Range* num_senders);

  // optional .RemyBuffers.Range link_limit = 74;
  inline bool has_link_limit() const;
  inline void clear_link_limit();
  static const int kLinkLimitFieldNumber = 74;
  inline const ::RemyBuffers::Range& link_limit() const;
  inline ::RemyBuffers::Range* mutable_link_limit();
  inline ::RemyBuffers::Range* release_link_limit();
  inline void set_allocated_link_limit(::RemyBuffers::Range* link_limit);
...
inline ::RemyBuffers::Range* ConfigRange::mutable_link_limit() {
  set_has_link_limit();
  if (link_limit_ == NULL) link_limit_ = new ::RemyBuffers::Range;
  return link_limit_;
}
