...
#define NS_OBJECT_ENSURE_REGISTERED(x)
#define NS_ABORT_MSG_UNLESS(x)

 //Apparently ns3 defines this
 #define m_segmentSize 1500
...
void
TcpCubic::DupAck (uint32_t count)
{
  NS_LOG_FUNCTION (this);
